...
export default function NumberConverter() {
    ...
    return <Container>
        <Config.Card>
            <Config.Option label="格式化数字" icon={() => <PaintRoller size={16} />}>
        ...
        <Card>
            ...
            <input class="input input-md outline-none w-full" value={hex()} onInput={(e) => update(e.target.value, 16)} />
        </Card>
        ...
        <Card>
            ...
            <input class="input input-md outline-none w-full" value={decimal()} onInput={(e) => update(e.target.value, 10)} />
        </Card>
        ...
        <Card>
            ...
            <input class="input input-md outline-none w-full" value={octal()} onInput={(e) => update(e.target.value, 8)} />
        </Card>
        ...
        <Card>
            ...
            <input class="input input-md outline-none w-full" value={binary()} onInput={(e) => update(e.target.value, 2)} />
        </Card>
    </Container>
}